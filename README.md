...
</p>  > Bot de WhatsApp estético, funcional y modular, desarrollado con Baileys, usando SQLite y una arquitectura limpia para bots principales, subbots y plugins.  <p align="center">    
...
<details>    
<summary><strong>🍃 Linux / Ubuntu</summary>  apt update && apt upgrade -y  apt install git nodejs ffmpeg build-essential -y
...
<summary><strong>🌾 Termux</summary>  termux-setup-storage  pkg update && pkg upgrade -y
...
<summary><strong>📍 Mantener el bot activo con PM2</summary>  Ejecuta estos comandos dentro de la carpeta del bot:  npm i -g pm2
...
</details>  > 🌾 Al iniciar, podrás elegir entre código de emparejamiento o código QR para vincular tu dispositivo.  
---
